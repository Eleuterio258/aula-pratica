...
<div class="container relative grid items-start gap-6 pt-4 pb-16 lg:grid-cols-4">
    ...
    <div
        ...
        <div class="relative space-y-5 divide-y divide-gray-200">
            ...
            <div class="relative">
                <div
                    class="absolute top-0 right-0 text-lg text-gray-400 cursor-pointer lg:hidden hover:text-primary">
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" id="Karl"
                            class="rounded-sm cursor-pointer text-primary focus:ring-0">
                        <label for="Karl" class="ml-3 text-gray-600 cursor-pointer">Karl</label>
                        <div class="ml-auto text-sm text-gray-600">(18)</div>
                    </div>
                    <!-- single brand name end -->
                    <!-- single brand name -->
                    <div class="flex items-center">
                        <input type="checkbox" id="Maxing"
                            class="rounded-sm cursor-pointer text-primary focus:ring-0">
                        <label for="Maxing" class="ml-3 text-gray-600 cursor-pointer">Maxing</label>
                        <div class="ml-auto text-sm text-gray-600">(09)</div>
                    </div>
                    <!-- single brand name end -->
                    <!-- single brand name -->
                    <div class="flex items-center">
                        <input type="checkbox" id="Ernest"
                            class="rounded-sm cursor-pointer text-primary focus:ring-0">
                        <label for="Ernest" class="ml-3 text-gray-600 cursor-pointer">Ernest</label>
                        <div class="ml-auto text-sm text-gray-600">(12)</div>
                    </div>
                    <!-- single brand name end -->
                </div>
            </div>
            ...
            <div class="overflow-hidden bg-white rounded shadow group">
                ...
                <div class="px-4 pt-4 pb-3">
                    ...
                    <div class="flex items-baseline mb-1 space-x-2">
                        <p class="text-xl font-semibold text-primary font-roboto">$45.00</p>
                        <p class="text-sm text-gray-400 line-through font-roboto">$55.00</p>
                    </div>
                    <div class="flex items-center">
