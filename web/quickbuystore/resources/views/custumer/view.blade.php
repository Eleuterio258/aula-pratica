@extends('layout.app') @section('titolo', 'Dashboard.') @section('content')
<!-- breadcrum -->
...
<!-- product view -->
<div class="container grid gap-6 pt-4 pb-6 lg:grid-cols-2">
    <!-- product image -->
    <div>
        <div>
    ...
    <div>
        ...
        <div class="flex items-baseline gap-3 mt-4">
            ...
            <span class="text-base text-gray-500 line-through">${{ $products->old }}</span>
        </div>
        ...
        <div class="flex gap-3 pb-5 mt-6 border-b border-gray-200">
            ...
            @else
                <a href="#"
                    class="flex items-center px-8 py-2 text-sm font-medium text-white uppercase transition border rounded bg-primary border-primary hover:bg-transparent hover:text-primary">
                    <span class="mr-2"><i class="fas fa-shopping-bag"></i></span> Add to cart
                </a>
            @endif

            <a href="#"
                class="px-8 py-2 text-sm font-medium text-gray-600 uppercase transition border border-gray-300 rounded hover:bg-transparent hover:text-primary">
