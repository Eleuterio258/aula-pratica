        ...
        <div class="col-span-3">
            ...
            <div class="p-4 mt-6 space-y-4 text-gray-600 bg-white divide-y divide-gray-200 rounded shadow">
                ...
                <div class="pl-8 space-y-1">
                    ...
                    <a href="change-password.html" class="block capitalize transition hover:text-primary text-primary">change password</a>
                </div>
                <!-- single link end -->
                <!-- single link -->
            ...
            <form action="">
                ...
                <div class="max-w-sm space-y-4">
                    <div>
                        ...
                        <div class="relative">
                            <span class="absolute text-sm text-gray-500 cursor-pointer right-3 top-3">
