<div class="relative bg-center bg-no-repeat bg-cover py-36" style="background-image: url('images/banner-bg.jpg')">
    <div class="container">
        ...
        <!-- banner button -->
        <div class="mt-12">
            <a href="shop.html" class="px-8 py-3 font-medium text-white uppercase transition border rounded-md bg-primary border-primary hover:bg-transparent hover:text-primary">
                Shop now
            </a>
        </div>
        <!-- banner button end -->
