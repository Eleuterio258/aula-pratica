...
//Route::get('orderdetalhe', [OrderController::class, 'orderdetalhe']);
Route::get('allOrderDetalhe', [OrderController::class, 'allOrderDetalhe']);
//Route::get('orderdetalhe', [OrderController::class, 'orderdetalhe']);
...
Route::get('allPagamento', [PagamentoController ::class, 'allPagamento']);
